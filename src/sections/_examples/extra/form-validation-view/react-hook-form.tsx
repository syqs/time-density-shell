...
const isOptionType = (option: any): option is OptionType => ((option as OptionType).value !== undefined);
          ...
          <Stack spacing={2}>
            ...
            <Block label="RHFAutocomplete">
              <RHFAutocomplete
                ...
                label="Autocomplete"
                options={OPTIONS}
            getOptionLabel={(option: OptionType | string) => isOptionType(option) ? option.label : option}
            isOptionEqualToValue={(option, value) => isOptionType(option) && isOptionType(value) ? option.value === value.value : option === value}
            renderOption={(props, option) => (
              <li {...props} key={isOptionType(option) ? option.value : option}>
                {isOptionType(option) ? option.label : option}
              </li>
            )}
              />
            </Block>
